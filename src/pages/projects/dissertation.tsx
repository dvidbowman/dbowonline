            ...
            <div className="pb-12">
              ...
              <div className="md:mx-4">
                <p>
                  ...
                  This is because most infections will occur during inspection
                  or replacement of dressings. The RGB values of pixels in the
                  colour-changing segment of the bandage would then be used to
                  check whether the wound has become infected - the segments
                  would start blue, but then turn more orange/yellow as more CO2
                  is absorbed. The application returns the analysis, and the
                  user knows whether they need to see a doctor.
                </p>
              </div>
            </div>
            <div className="pb-12">
              ...
              <div className="md:mx-4">
                ...
                <p className="pb-4">
                  I used OpenCV to automatically detect and analyse the
                  bandages, and with colour accuracy being the main concern,
                  this presented a near-endless list of problems; how will it
                  know where the bandage is? What effect will lighting have on
                  the analysis? Are different cameras going to change results?
                  It soon became clear that I would have to focus more on
                  researching the problem before I could create a robust
                  solution. Let's instead make a very basic app that has some
                  primary functions with the goal of analysing the lighting's
                  effect on results.
                </p>
                <p>
                  I got the basic bandage detection to work after some wrestling
                  with edge detectors, and a lot of calculations later the
                  results obtained were promising. It seemed that consistent
                  discernable colour changes could be detected across different
                  lighting temperatures, and that with some more fine tuning it
                  may be accurate enough to use medically.
                </p>
              </div>
            </div>
            <div className="pb-12">
              ...
              <div className="md:mx-4">
                ...
                <p className="pb-4">
                  ...
                  PHP, but the hardest stuff was definitely the OpenCV library.
                  It allowed me a greater appreciation for anything computer
                  vision related.
                </p>
                <p>
                  Overall, this project provided more for me in terms of
                  personal skills; having to follow the entire life cycle from
                  planning to evaluation let me hone skills that I can apply in
                  almost any situation. I had a real chance to improve my
                  organisation and time management through a larger project like
                  this, constantly meeting small deadlines and not letting any
                  one part of the system fall behind.
                </p>
              </div>
            </div>
            <div className="pb-16">
