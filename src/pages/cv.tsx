  ...
  return (
    <>
      ...
      <main className="mx-12 flex min-h-screen flex-col md:mx-24">
        ...
        <section className="my-12 mt-10 px-4 md:mt-16">
          <div className="h-full w-full">
            <div className="m-auto mb-4 w-[90%] bg-[#f5f5f5] md:w-[70%]">
              <div className="h-full w-full px-10 py-8">
                <h1 className="text-[26px] font-bold underline decoration-blue-300 underline-offset-4">
                  Profile
                </h1>
            ...
            <div className="m-auto mb-4 w-[90%] bg-[#f5f5f5] md:w-[70%]">
              <div className="h-full w-full px-10 py-8">
                ...
                <p className="pt-2 text-[20px] font-semibold">
                  2019 - 2022 | Queen's University Belfast
                </p>
                <p className="pb-2 text-[18px]">
            ...
            <div className="m-auto mb-4 w-[90%] bg-[#f5f5f5] md:w-[70%]">
              <div className="h-full w-full px-10 py-8">
                ...
                <p className="pt-2 text-[18px]">
                  <span className="pt-2 text-[20px] font-semibold">
